...
const rectToColors = (colors, [tl, tr, br, bl]) => [
  colors[tl],
  colors[tr],
  colors[br],
  colors[bl],
...
export const CoonsPatchMeshGradient = ({
  ...
  const image = useImage(require("../../images/debug.png"));
  const dx = width / cols;
  ...
  return (
    <View style={{flex: 1, position: 'absolute', top: 0, bottom: 0, left: 0, right: 0, flex: 1, zIndex: -1000}}>
